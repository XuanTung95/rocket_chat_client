...
import 'package:rocket_chat_client/src/models/new/channel_new.dart';
import 'package:rocket_chat_client/src/models/user.dart';
import 'package:rocket_chat_client/src/models/users_autocomplete_response.dart';
...
abstract class RocketChatApi {
  ...
  Future<MessageNewResponse> createGroup(@Body() ChannelNew body);
